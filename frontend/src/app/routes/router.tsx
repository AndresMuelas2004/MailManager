...
const UnifiedInboxPage = lazy(
  () => import("../../features/emails/pages/UnifiedInboxPage"),
);
const AccountInboxPage = lazy(
  () => import("../../features/emails/pages/AccountInboxPage"),
);
const DraftsPage = lazy(() => import("../../features/drafts/pages/DraftsPage"));
const AccountDraftsPage = lazy(
  () => import("../../features/drafts/pages/AccountDraftsPage"),
);
